...
public class S01961_CreateNewWorkType_Saucelab_Run {
...
//			driver = new ChromeDriver(option);
			...
			option.setPlatformName("macOS 11.00");
			...
			driver = new RemoteWebDriver(new URL("https://oauth-velsprog-a7b27:c6436a7f-55a5-4b6d-bcd4-52bf2ecfc319@ondemand.eu-central-1.saucelabs.com:443/wd/hub"), capabilities);
