...
public class S011073_Certificationssortorder extends BaseClass {
	
	public List<String> certList,sortedList;

	@Test
	public void certificationSortingCheck() {
		...
		driver.findElement(By.xpath("//button[contains(text(),'Sort by popularity')]")).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(text(),'Sort alphabetically')]")));
		driver.findElement(By.xpath("//button[contains(text(),'Sort alphabetically')]")).click();
